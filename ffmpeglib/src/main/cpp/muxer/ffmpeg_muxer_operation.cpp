...
static FFmpegMuxer *muxer = new FFmpegMuxer;
...
Java_com_glumes_ffmpeglib_muxer_FFmpegMuxerOperation_demuxerSample__Ljava_lang_String_2Ljava_lang_String_2Ljava_lang_String_2(
        JNIEnv *env, jobject instance, jstring input_file_, jstring output_video_file_,
        jstring output_audio_file_) {
    ...
    muxer->muxer_simple(input_file, output_video_file, output_audio_file);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_glumes_ffmpeglib_muxer_FFmpegMuxerOperation_demuxerStandard(JNIEnv *env, jobject instance,
                                                                     jstring input_file_,
    ...
    muxer->muxer_standard(input_file, output_video_file, output_audio_file);
